...
public class StringListChooser extends ListChooser {
     ...
     */
    public StringListChooser(java.awt.Frame parent, ArrayList<String> items, String dialogTitle, String panelTitle, String instructionsLabel) {
        super(parent, items, dialogTitle, panelTitle, instructionsLabel);
