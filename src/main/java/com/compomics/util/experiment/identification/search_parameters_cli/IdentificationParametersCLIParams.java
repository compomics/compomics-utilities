...
public enum IdentificationParametersCLIParams {
    ...
    OMSSA_SINGLE_WINDOW_WIDTH("omssa_single_window_width", "OMSSA single charge window width in Da, integer, default is '27'.", false),
    OMSSA_DOUBLE_WINDOW_WIDTH("omssa_double_window_width", "OMSSA double charge window width in Da, integer, default is '14'.", false),
