...
public enum IdentificationParametersCLIParams {
    ...
    COMET_PTMS("comet_num_ptms", "Comet max number of PTMs per peptide, 1: true, 0: false, default is '0'.", false),
    COMET_REQ_PTMS("comet_req_ptms", "Comet require at least one variable PTM per peptide, 1: true, 0: false, default is '0'.", false),
