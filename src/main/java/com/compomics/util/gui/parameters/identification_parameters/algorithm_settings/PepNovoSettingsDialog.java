 ...
 */
public class PepNovoSettingsDialog extends javax.swing.JDialog implements AlgorithmSettingsDialog {
     ...
     * the user
     */
    public PepNovoSettingsDialog(java.awt.Frame parent, PepnovoParameters pepNovoParameters, boolean editable) {
        super(parent, true);
     ...
     * the user
     */
    public PepNovoSettingsDialog(Dialog owner, java.awt.Frame parent, PepnovoParameters pepnovoParameters, boolean editable) {
        super(owner, true);
        this.editable = editable;
        initComponents();
        setUpGUI();
