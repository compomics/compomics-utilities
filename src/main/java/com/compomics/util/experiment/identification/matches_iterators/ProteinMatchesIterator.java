...
public class ProteinMatchesIterator extends MatchesIterator {
     ...
     */
    public ProteinMatchesIterator(Identification identification, boolean lazyLoading, WaitingHandler waitingHandler, boolean displayProgress) throws SQLException, IOException, ClassNotFoundException, InterruptedException {
     ...
     * @throws java.lang.InterruptedException
     */
    public ProteinMatchesIterator(ArrayList<String> keys, Identification identification, boolean lazyLoading, WaitingHandler waitingHandler, boolean displayProgress) throws SQLException, IOException, ClassNotFoundException, InterruptedException {
        super(keys, ProteinMatch.class.getSimpleName(), identification, lazyLoading, waitingHandler, displayProgress);
    }
