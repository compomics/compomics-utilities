...
public class SequenceDbDetailsDialog extends javax.swing.JDialog {
     ...
     */
    public SequenceDbDetailsDialog(Dialog owner, Frame parent, UtilitiesUserParameters utilitiesUserParameters, LastSelectedFolder lastSelectedFolder, boolean dbEditable, Image normalImange, Image waitingImage) {
        super(owner, true);
        initComponents();
     ...
     * @param waitingImage the waiting icon
     */
    public SequenceDbDetailsDialog(Frame parent, UtilitiesUserParameters utilitiesUserParameters, LastSelectedFolder lastSelectedFolder, boolean dbEditable, Image normalImange, Image waitingImage) {
