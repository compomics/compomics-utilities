...
public class ProteinSequenceIteratorTest extends TestCase {
    ...
    public void testEnzymeDigestion() throws XmlPullParserException, IOException {
        ...
        IteratorFactory iteratorNoModifications = new IteratorFactory(new ArrayList<String>());
        ...
        // No modification
        ArrayList<IteratorFactory.PeptideWithPosition> peptides = iteratorNoModifications.getPeptides(testSequence, digestionPreferences, null, null);
