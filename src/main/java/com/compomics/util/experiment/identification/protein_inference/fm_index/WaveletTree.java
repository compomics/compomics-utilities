        ...
        if ((leftIndex < rightIndex)) {
            ...
            if (continueLeftRangeQuery) {
                ...
                if (leftChild != null) {
                    ...
                    setCharacter.add(new Integer[]{(int) charAlphabetField[0], newLeftIndex, newRightIndex, (int) charAlphabetField[0]});
                }
            }
            ...
            if (continueRightRangeQuery) {
                ...
                if (rightChild != null) {
                    ...
                    setCharacter.add(new Integer[]{(int) charAlphabetField[lenAlphabet - 1], newLeftIndex + 1, newRightIndex + 1, (int) charAlphabetField[lenAlphabet - 1]});
                }
            }
        }
    }
