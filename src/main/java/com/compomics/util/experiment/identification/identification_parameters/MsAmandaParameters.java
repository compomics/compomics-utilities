...
public class MsAmandaParameters implements IdentificationAlgorithmParameter {
     ...
     */
    //static final long serialVersionUID = -2656523093031942973L; // @TODO: update!!
    /**
     * Maximal e-value cut-off.
     */
    private Double maxEValue = 100.0;
    /**
     * Indicates whether MS Amanda is to create and search a decoy database or not.
     */
...
//    private Integer numberOfPtmsPerPeptide = 2;
    ...
    public boolean equals(IdentificationAlgorithmParameter identificationAlgorithmParameter) {
        ...
        if (identificationAlgorithmParameter instanceof MsAmandaParameters) {
            MsAmandaParameters msgfParameters = (MsAmandaParameters) identificationAlgorithmParameter;
