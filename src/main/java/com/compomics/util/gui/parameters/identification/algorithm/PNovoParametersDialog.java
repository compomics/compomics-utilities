...
public class PNovoParametersDialog extends javax.swing.JDialog implements AlgorithmParametersDialog {
     ...
     */
    public PNovoParametersDialog(java.awt.Frame parent, PNovoParameters pNovoParameters, boolean editable) {
        super(parent, true);
     ...
     * @param editable boolean indicating whether the settings can be edited by the user
     */
    public PNovoParametersDialog(Dialog owner, java.awt.Frame parent, PNovoParameters pNovoParameters, boolean editable) {
        super(owner, true);
        this.editable = editable;
        initComponents();
        setUpGUI();
