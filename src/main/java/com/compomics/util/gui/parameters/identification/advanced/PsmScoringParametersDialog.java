...
public class PsmScoringParametersDialog extends javax.swing.JDialog {
     ...
     * the user
     */
    public PsmScoringParametersDialog(java.awt.Frame parentFrame, PsmScoringParameters psmScoringPreferences, boolean editable) {
     ...
     * the user
     */
    public PsmScoringParametersDialog(Dialog owner, java.awt.Frame parentFrame, PsmScoringParameters psmScoringPreferences, boolean editable) {
        super(owner, true);
        this.parentFrame = parentFrame;
        this.editable = editable;
        initComponents();
