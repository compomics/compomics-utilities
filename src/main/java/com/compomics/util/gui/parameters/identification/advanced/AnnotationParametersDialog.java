...
public class AnnotationParametersDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        intensityThresholdCmb.setModel(new DefaultComboBoxModel(com.compomics.util.experiment.identification.spectrum_annotation.AnnotationParameters.IntensityThresholdType.values()));
