    ...
    public void testFragmentation() {
        ...
        for (PeptideFragmentIon peptideFragmentIon : fragments) {
            if (peptideFragmentIon.getNumber() == 1) {
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.BH2O_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.YH2O_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.YNH3_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.ANH3_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.BNH3_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.MHH2O_ION) {
                    Assert.assertTrue(
                            Math.abs(peptideFragmentIon.theoreticMass + Atom.H.mass - 2377.1216) < tolerance);
                } else if (peptideFragmentIon.getType() == PeptideFragmentIonType.MHNH3_ION) {
                    Assert.assertTrue(
