...
public enum IdentificationParametersCLIParams {
    ...
    //TIDE_MIN_PTMS("tide_min_ptms", "Tide min number of PTMs per peptide, default is '0'.", false, true),
    TIDE_MAX_PTMS("tide_max_ptms", "Tide max number of PTMs per peptide, default is '255'.", false, true),
