...
public class FilterDialog extends javax.swing.JDialog {
     ...
     * @param allModifications the modifications that can be used for filtering
     */
    public FilterDialog(javax.swing.JDialog parent, MatchFilter filter, ArrayList<String> allModifications) {
        super(parent, true);
