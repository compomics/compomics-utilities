...
public class OmssaParametersDialog extends javax.swing.JDialog implements AlgorithmParametersDialog {
    ...
    public OmssaParameters getInput() {
        ...
        tempOmssaParameters.setLowIntensityCutOff(Double.valueOf(input));
        input = highIntensityTxt.getText().trim();
        tempOmssaParameters.setHighIntensityCutOff(Double.valueOf(input));
        input = intensityIncrementTxt.getText().trim();
        tempOmssaParameters.setIntensityCutOffIncrement(Double.valueOf(input));
        input = nPeaksTxt.getText().trim();
        tempOmssaParameters.setMinPeaks(Integer.valueOf(input));
        ...
        tempOmssaParameters.setFractionOfPeaksForChargeEstimation(Double.valueOf(input));
        input = minPrecPerSpectrumTxt.getText().trim();
        tempOmssaParameters.setMinPrecPerSpectrum(Integer.valueOf(input));
        ...
        if (!input.equals("")) {
            tempOmssaParameters.setMinPeptideLength(Integer.valueOf(input));
        }
        input = maxPepLengthTxt.getText().trim();
        if (!input.equals("")) {
            tempOmssaParameters.setMaxPeptideLength(Integer.valueOf(input));
        }
        input = maxEvalueTxt.getText().trim();
        tempOmssaParameters.setMaxEValue(Double.valueOf(input));
        input = hitlistTxt.getText().trim();
        tempOmssaParameters.setHitListLength(Integer.valueOf(input));
        ...
        int charge = Integer.valueOf(input);
        tempOmssaParameters.setMinimalChargeForMultipleChargedFragments(charge);
        input = neutronTxt.getText().trim();
        tempOmssaParameters.setNeutronThreshold(Double.valueOf(input));
        input = singlyChargedWindowWidthTxt.getText().trim();
        tempOmssaParameters.setSingleChargeWindow(Integer.valueOf(input));
        input = doublyChargedWindowWidthTxt.getText().trim();
        tempOmssaParameters.setDoubleChargeWindow(Integer.valueOf(input));
        input = singlyChargedNpeaksTxt.getText().trim();
        tempOmssaParameters.setnPeaksInSingleChargeWindow(Integer.valueOf(input));
        input = doublyChargedNpeaksTxt.getText().trim();
        tempOmssaParameters.setnPeaksInDoubleChargeWindow(Integer.valueOf(input));
        input = minAnnotatedMostIntensePeaksTxt.getText().trim();
        tempOmssaParameters.setnAnnotatedMostIntensePeaks(Integer.valueOf(input));
        input = minAnnotatedPeaksTxt.getText().trim();
        tempOmssaParameters.setMinAnnotatedPeaks(Integer.valueOf(input));
        input = nHitsPerSpectrumPerChargeTxt.getText().trim();
        tempOmssaParameters.setMaxHitsPerSpectrumPerCharge(Integer.valueOf(input));
        input = maxLaddersTxt.getText().trim();
        tempOmssaParameters.setMaxMzLadders(Integer.valueOf(input));
        input = maxFragmentChargeTxt.getText().trim();
        tempOmssaParameters.setMaxFragmentCharge(Integer.valueOf(input));
        ...
        tempOmssaParameters.setMaxFragmentPerSeries(Integer.valueOf(input));
        ...
        tempOmssaParameters.setConsecutiveIonProbability(Double.valueOf(input));
        input = iterativeSequenceEvalueTxt.getText().trim();
        tempOmssaParameters.setIterativeSequenceEvalue(Double.valueOf(input));
        input = iterativeSpectraEvalueTxt.getText().trim();
        tempOmssaParameters.setIterativeSpectrumEvalue(Double.valueOf(input));
        input = iterativeReplaceEvalueTxt.getText().trim();
        tempOmssaParameters.setIterativeReplaceEvalue(Double.valueOf(input));
    ...
    private void initComponents() {
        ...
        advancedSearchSettingsPanelLayout.setVerticalGroup(
            ...
            .addGroup(advancedSearchSettingsPanelLayout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addComponent(searchSettingsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 481, Short.MAX_VALUE)
                .addContainerGap())
        );
