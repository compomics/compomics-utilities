...
public class EnzymeParametersDialog extends javax.swing.JDialog {
     ...
     * the user
     */
    public EnzymeParametersDialog(java.awt.Frame parent, boolean modal, String enzymeName, boolean editable) {
        super(parent, modal);
        initComponents();
     ...
     * the user
     */
    public EnzymeParametersDialog(Dialog owner, java.awt.Frame parent, boolean modal, String enzymeName, boolean editable) {
        super(owner, modal);
        initComponents();
        prideEnzymeNameTextField.setText(enzymeName);
        enzymesCmb.setRenderer(new com.compomics.util.gui.renderers.AlignedListCellRenderer(SwingConstants.CENTER));
