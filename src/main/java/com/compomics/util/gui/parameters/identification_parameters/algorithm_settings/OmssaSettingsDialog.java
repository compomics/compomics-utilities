...
public class OmssaSettingsDialog extends javax.swing.JDialog implements AlgorithmSettingsDialog {
    ...
    public boolean validateInput(boolean showMessage) {
        ...
        valid = GuiUtilities.validatePositiveIntegerInput(this, nPeaksLbl, nPeaksTxt, "number of peaks per spectrum", "Number of Peaks Error", true, showMessage, valid);
        ...
        valid = GuiUtilities.validatePositiveIntegerInput(this, minPrecPerSpectrumLbl, minPrecPerSpectrumTxt, "number of precursor per spectrum", "Number of Precursors Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, peptideLengthJLabel, minPepLengthTxt, "minimim peptide length", "Peptide Length Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, peptideLengthJLabel, maxPepLengthTxt, "maximum peptide length", "Peptide Length Error", true, showMessage, valid);
        ...
        valid = GuiUtilities.validatePositiveIntegerInput(this, hitListLbl, hitlistTxt, "hitlist length", "Hitlist Length Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, nHitsPerSpectrumPerChargeLbl, nHitsPerSpectrumPerChargeTxt, "number of hits per spectrum and per charge", "Hits per Spectrum and per Charge Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, minPrecursorChargeConsideredMultiplyChargedFragmentsJLabel, minPrecChargeMultipleChargedFragmentsTxt, "minimal charge to consider multiply charged fragments", "Minimal Charge for Multiple Fragments Error", true, showMessage, valid);
        ...
        valid = GuiUtilities.validatePositiveIntegerInput(this, singlyChargedWindowWidthLbl, singlyChargedWindowWidthTxt, "size for single charge windows", "Window Size Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, doublyChargedWindowWidthLbl, doublyChargedWindowWidthTxt, "size for double charge windows", "Window Size Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, singlyChargedNPeaksLbl, singlyChargedNpeaksTxt, "number of peaks for single charge windows", "Window Number of Peaks Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, doublyChargedNPeaksLbl, doublyChargedNpeaksTxt, "number of peaks for double charge windows", "Window Number of Peaks Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, minAnnotatedMostIntensePeaksLbl, minAnnotatedMostIntensePeaksTxt, "number for the minimal number of annotated peaks among the most intense ones", "Number of Annotated Intense Peaks Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, minAnnotatedPeaksLbl, minAnnotatedPeaksTxt, "number for the minimal number of annotated peaks", "Number of Annotated Peaks Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, maxLaddersLbl, maxLaddersTxt, "number for the maximal m/z ladder size", "Ladder Size Error", true, showMessage, valid);
        valid = GuiUtilities.validatePositiveIntegerInput(this, maxFragmentsPerSeriesLbl, maxFragmentsPerSeriesTxt, "number for the maximal number of fragments per series", "Fragments per Series Error", true, showMessage, valid);
