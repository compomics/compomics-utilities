...
public class Protein extends ExperimentObject {
    ...
    /**
     * Returns true if the peptide is enzymatic, i.e., both termini can be generated by the enzyme used.
     * If a peptide maps to multiple locations in the
    ...
    /**
     * Returns true if the peptide is enzymatic, i.e., both termini can be generated by one of the enzymes used.
     * If a peptide maps to multiple locations in the
     * protein sequence this method returns true if one or more of these
     * peptides are enzymatic, even if not all mappings are enzymatic.
     *
