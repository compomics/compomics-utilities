...
public class ValidationParametersDialog extends javax.swing.JDialog {
     ...
     * the user
     */
    public ValidationParametersDialog(java.awt.Frame parentFrame, IdMatchValidationParameters idMatchValidationPreferences, boolean editable) {
     ...
     * the user
     */
    public ValidationParametersDialog(Dialog owner, java.awt.Frame parentFrame, IdMatchValidationParameters idMatchValidationPreferences, boolean editable) {
        super(owner, true);
        this.parentFrame = parentFrame;
        this.editable = editable;
        initComponents();
    ...
    private void populateGUI(IdMatchValidationParameters idMatchValidationPreferences) {
        ...
        proteinFdrTxt.setText(Double.toString(idMatchValidationPreferences.getDefaultProteinFDR()));
        peptideFdrTxt.setText(Double.toString(idMatchValidationPreferences.getDefaultPeptideFDR()));
        psmFdrTxt.setText(Double.toString(idMatchValidationPreferences.getDefaultPsmFDR()));
