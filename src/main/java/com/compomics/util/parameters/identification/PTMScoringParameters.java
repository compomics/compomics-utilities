 ...
 */
public class PTMScoringParameters implements Serializable {
     ...
     */
    public boolean equals(PTMScoringParameters otherPtmScoringPreferences) {
