...
/**
 * An iterator of the spectra in an mzml file. Based on jMzML.
 *
 * @author Harald Barsnes
 */
public class MzmlFileIteratorJmzML implements MsFileIterator {
     ...
     */
    public MzmlFileIteratorJmzML(File mzmlFile, WaitingHandler waitingHandler) {
