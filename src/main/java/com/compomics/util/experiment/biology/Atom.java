...
public abstract class Atom extends ExperimentObject {
    ...
    /**
     * returns a list of isotopes for which a mass is available relative to the monoisotopic peak (+1 for carbon 13).
     * 
     ...
     * 
     * @param isotopeNumber the isotope number of interest relative to the monoisotopic peak (+1 for carbon 13).
     * 
     ...
     * 
     * @param isotopeNumber the isotope number relative to the monoisotopic peak (+1 for carbon 13)
     * 
     * @return the mass difference between the given isotope and the monoisotopic mass
     */
