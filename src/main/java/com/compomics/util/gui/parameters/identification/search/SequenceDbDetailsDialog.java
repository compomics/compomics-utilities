 ...
 */
public class SequenceDbDetailsDialog extends javax.swing.JDialog { // @TODO: currently not in use
...
//
//                decoyButton.setEnabled(!fastaSummary.isTargetDecoy() && dbEditable);
//
...
//        if (fastaSummary != null && fastaSummary.isTargetDecoy()) {
