...
public class AtomChainDialog extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AtomChainDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AtomChainDialog dialog = new AtomChainDialog(new javax.swing.JFrame(), null, true);
    ...
    private void initComponents() {
        ...
        compositionPanelLayout.setHorizontalGroup(
            ...
            .addGroup(compositionPanelLayout.createSequentialGroup()
                ...
                .addGroup(compositionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(compositionPanelLayout.createSequentialGroup()
                        .addComponent(compositionTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 279, Short.MAX_VALUE)
            ...
            .addGroup(editPanelLayout.createSequentialGroup()
                ...
                .addGroup(editPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(editPanelLayout.createSequentialGroup()
                        ...
                        .addGap(22, 22, 22)
                        .addGroup(editPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(isotopeCmb, 0, 247, Short.MAX_VALUE)
