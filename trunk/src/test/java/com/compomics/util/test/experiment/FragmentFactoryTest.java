    ...
    public void testFragmentation() {
        ...
        for (PeptideFragmentIon peptideFragmentIon : fragments) {
            if (peptideFragmentIon.getNumber() == 1) {
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.Z_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.BH2O_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.YH2O_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.YNH3_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.ANH3_ION) {
                    Assert.assertTrue(
                ...
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.BNH3_ION) {
                    Assert.assertTrue(
                ...
                if (peptideFragmentIon.getType() == PeptideFragmentIon.MH_ION) {
                    Assert.assertTrue(
                            Math.abs(peptideFragmentIon.theoreticMass + Atom.H.mass - 2395.1322) < tolerance);
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.MHH2O_ION) {
                    Assert.assertTrue(
                            Math.abs(peptideFragmentIon.theoreticMass + Atom.H.mass - 2377.1216) < tolerance);
                } else if (peptideFragmentIon.getType() == PeptideFragmentIon.MHNH3_ION) {
                    Assert.assertTrue(
